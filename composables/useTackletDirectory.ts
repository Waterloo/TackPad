...
const tacklets = shallowRef<Tacklet[]>([
    {
      id: 1,
      title: "Tackpad Draw",
      description: "Unleash your creativity—doodle, sketch, and bring your ideas to life right on your board!",
      type: "Tacklet",
      iconText: "DR",
    ...
    },
    {
      id: 2,
      title: "White Noise",
      description: "Block distractions and dive into deep focus with calming white noise.",
      iconText: "WN",
    ...
    },
    {
      id: 3,
      title: "Napkin Math",
      description: "Quick, no-fuss calculations—just like scribbling on the back of a napkin.",
      iconText: "M",
    ...
    },
    {
      ...
      description: "Stay productive with the Pomodoro technique—focus, break, and repeat!",
      iconText: "T",
