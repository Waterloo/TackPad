    ...
    <div class="page-container">
      ...
      <div class="card">
        ...
        <div class="card-section">
          <div class="app-info">
            <div class="app-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="color: #6b7280;">
        ...
        <div class="card-section">
          ...
          <ul class="permissions-list">
            <li v-for="(permission, index) in permissions" :key="index" class="permission-item">
              <svg class="permission-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          ...
          <p class="permission-note">
            {{ application.name }} will not be able to access your account password or personal information.
          </p>
        </div>
      ...
      <!-- Footer -->
      <div class="footer">
        <p>By authorizing this application, you agree to Tackpad's <a href="#" @click.prevent="showTerms">Terms of Service</a> and <a href="#" @click.prevent="showPrivacy">Privacy Policy</a>.</p>
      </div>
    </div>
  </template>
