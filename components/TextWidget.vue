          ...
          <Button
                ...
                <Popover ref="fontPopover">
                  <div class="flex flex-col gap-2 w-48">
                    ...
                    <Button
                      ...
                      :severity="selectedFont === font.label ? 'primary' : 'secondary'"
                      size="small"
                      class="justify-start"
                        ...
                        <Popover ref="sizePopover">
                          <div class="flex flex-col gap-2 w-32">
                            ...
                            <Button
                              ...
                              :severity="fontSize === size.value ? 'primary' : 'secondary'"
                              size="small"
                              class="justify-start"
                            />
                          </div>
                  ...
                  <div class="flex flex-col gap-3 w-64">
                    ...
                    <div class="flex gap-2 flex-wrap">
                      <button
                        ...
                        :class="{ 'border-blue-500': textColor === color, 'border-gray-300': textColor !== color }"
                    ...
                    <div class="flex gap-2 items-center">
                      <label class="text-sm whitespace-nowrap">Custom:</label>
                ...
                <div class="flex gap-1 mr-2">
                  ...
                  <Button
                    ...
                    class="w-8 h-8 p-0"
                  >
                    <span class="text-xs font-bold" style="text-decoration: underline;">U</span>
                  </Button>
                </div>
...
function initializeFormatting() {
  if (props.initialFormatting) {
    ...
    selectedFont.value = fonts.find(f => f.value === fmt.fontFamily)?.label || 'Arial'
...
function updateTextWidget() {
  const formatting: TextWidgetFormatting = {
    fontFamily: fonts.find(f => f.label === selectedFont.value)?.value || 'Arial, sans-serif',
...
function getTextStyle() {
  const fontFamily = fonts.find(f => f.label === selectedFont.value)?.value || 'Arial, sans-serif'
  return {
    fontFamily,
...
function cycleAlign() {
  const currentIndex = alignOptions.findIndex(option => option.value === textAlign.value)
...
watch(() => props.initialFormatting, (newFormatting) => {
  if (newFormatting) {
